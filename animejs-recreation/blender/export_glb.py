...
5. Writes blender/anime_engine.blend and public/models/anime-engine.glb.
"""
...
def _resolve_repo(explicit=None):
    if explicit:
        return explicit
    guess = r"C:\Users\awaiz\OneDrive\Desktop\scroll\animejs-recreation"
    return guess
...
def export(repo=None):
    ...
    blend_path = os.path.join(repo, "blender", "anime_engine.blend")
    glb_path = os.path.join(repo, "public", "models", "anime-engine.glb")
